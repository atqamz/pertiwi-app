...
import { clearErrors, getOrder, adminDeleteOrder } from "../../../_actions/orderAction";

import Loading from "../../layout/Loading/Loading";
import { ADMIN_DELETE_ORDER_RESET } from "../../../_constants/orderConstant";

const OrderUpdate = ({ match, history }) => {
  const alert = useAlert();
  const dispatch = useDispatch();
  const { loading, error, order, isDeleted } = useSelector((state) => state.orderState);
  ...
  }, [dispatch, error, alert, match.params.orderId, isDeleted, history]);
